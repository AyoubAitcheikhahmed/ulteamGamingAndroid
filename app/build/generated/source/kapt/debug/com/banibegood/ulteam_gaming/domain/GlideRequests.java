...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.banibegood.ulteam_gaming.domain.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.banibegood.ulteam_gaming.domain.GlideOptions().apply(toSet));
    }
  }
}
